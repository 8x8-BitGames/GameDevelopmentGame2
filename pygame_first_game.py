...
class Player:
    def __init__(self):
        ...
        self.triple_jump_max_duration = 600  # 10 seconds at 60 FPS
        ...
        self.dash_max_duration = 600  # 10 seconds at 60 FPS
...
def draw_boston_skyline(screen, scroll_offset, distance):
    ...
    # Don't draw buildings at all until we reach skyline_start
    ...
    # Calculate how much the skyline has scrolled based on distance traveled in this section
    skyline_distance = distance - skyline_start
    parallax_scroll = skyline_distance * 0.3

    # The skyline starts positioned just off-screen to the right
    # Start them at WIDTH so the first building appears right at the edge
    initial_offset = WIDTH
    parallax_offset = initial_offset - parallax_scroll
    import pygame
    import random
    import math
    ...
    def main():
        ...
        while running:
            ...
            # Draw Boston skyline with sequential slide-in effect
